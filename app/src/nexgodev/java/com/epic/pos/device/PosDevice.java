...
import static com.nexgo.oaf.apiv3.emv.EmvModeEnum.MSD;
...
public class PosDevice {
    ...
    public  boolean isamexmsd =false;
            ...
            public void onCardInfo(int retCode, final CardInfoEntity cardInfo) {
                ...
                if (retCode == SdkResult.Success) {
                    ...
                    if (mExistSlot == CardSlotTypeEnum.SWIPE) {
                        ...
                        log("currencyCode: " + getCurrencyCode());
                        ...
                        transData.setCurrencyCode(getCurrencyCode());
                        ...
                        Log.d("RFTYPE", String.valueOf(cardInfo.getRfCardType()));

                        emvHandler2.emvDebugLog(false);

//                        File outputFile = new File(getExternalStorageDirectory().getAbsolutePath(),"logcat.txt");
//                        try {
...
//                        }
                        ...
                        if(isExpressPaySeePhoneTapCardAgain){
                            ...
                            transData.setAmexTransDataEntity(amexTransDataEntity);
                        }
                            ...
                            public void onTransInitBeforeGPO() {
                                ...
                                if (mExistSlot == CardSlotTypeEnum.RF) {
                                    ...
                                    if (isVisaAid()) {
                                      ...
                                      //  int s=emvHandler2.setTlv(ByteUtils.hexString2ByteArray("9F33"), ByteUtils.hexString2ByteArray(visaAid.getCTLSPinSupportValue()));
                                     ...
                                     //   setPaywaveDrl();
                                        ...
                                        //Master
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8123"), ByteUtils.hexString2ByteArray(masterAid.getFLAmt()));
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8124"), ByteUtils.hexString2ByteArray(masterAid.getTxnAmt()));
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8126"), ByteUtils.hexString2ByteArray(masterAid.getCVMLAmt()));
                                      ...
                                      //  emvHandler2.setTlv(new byte[]{(byte) 0xDF, (byte) 0x81, (byte) 0x19}, new byte[]{(byte) 0x08});
                                        ...
                                        emvHandler2.setTlv(new byte[]{(byte) 0xDF, (byte) 0x81, (byte) 0x25}, ByteUtils.hexString2ByteArray("000099999999"));

                                    //TacDefault
                                    emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8120"), ByteUtils.hexString2ByteArray("fc5084800c"));
                                    //TacDecline
                                    emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8121"), ByteUtils.hexString2ByteArray("0000000000"));
                                    //TacOnline
                                    emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8122"), ByteUtils.hexString2ByteArray("fc5084800c"));

                                        Log.d("",  "MASTERAID - " + ByteUtils.byteArray2HexString(aid));
                                        if (ByteUtils.byteArray2HexString(aid).toUpperCase().contains("A0000000043060")) {
                                            Log.d("",  "MASTERAID - Mistro " + ByteUtils.byteArray2HexString(aid));
                                            Log.d("nexgo",  "======maestro===== ");

                                            //TacDefault
                                            emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8120"), ByteUtils.hexString2ByteArray("fc5004800c"));
                                            //TacDecline
                                            emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8121"), ByteUtils.hexString2ByteArray("0000800000"));
                                            //TacOnline
                                            emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8122"), ByteUtils.hexString2ByteArray("fc5004800c"));

//                                            emvHandler2.setTlv(new byte[]{(byte) 0xDF, (byte) 0x81, (byte) 0x1B}, new byte[]{(byte) 0xA0});
//                                            //maestro only support online pin
                                           emvHandler2.setTlv(new byte[]{(byte) 0x9F, (byte) 0x33}, new byte[]{(byte) 0xE0, (byte) 0xF8, (byte) 0xC8});
                                           // emvHandler2.setTlv(new byte[]{(byte) 0x9F, (byte) 0x33}, new byte[]{(byte) 0xE0, (byte) 0x60, (byte) 0x08});
                                            ...
                                            //set 9F1D terminal risk management - MasterCard. it should be same with the MTIP configuration for 9F1D  // 190101 BBBBB
                                        ...
                                        //AMEX
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8123"), ByteUtils.hexString2ByteArray(amexAid.getFLAmt()));
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8124"), ByteUtils.hexString2ByteArray(amexAid.getTxnAmt()));
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8126"), ByteUtils.hexString2ByteArray(amexAid.getCVMLAmt()));
                                        ...
                                        log("CTLS - Amex terminal capabilities are updated.");
                                            ...
                                            TTC = ByteUtils.hexString2ByteArray("DCF04083");
                                            kernelTTC[1] = TTC[1];

                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("9F6E"), kernelTTC);
                                        emvHandler2.setTlv(new byte[]{(byte) 0x82}, new byte[]{(byte) 0xFD, (byte) 0xC0});
                                        emvHandler2.setTlv(new byte[]{(byte) 0x9F, (byte) 0x6D}, ByteUtils.hexString2ByteArray("C8"));
                                        emvHandler2.setTlv(new byte[]{(byte) 0xDF, (byte) 0x81, (byte) 0x1B}, new byte[]{(byte) 0x38});

                                    } else if (isDinersAid()){
                                        //Diners
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8123"), ByteUtils.hexString2ByteArray(dinersAid.getFLAmt()));
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8124"), ByteUtils.hexString2ByteArray(dinersAid.getTxnAmt()));
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8126"), ByteUtils.hexString2ByteArray(dinersAid.getCVMLAmt()));
                                        ...
                                        //JCB
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8123"), ByteUtils.hexString2ByteArray(jcbAid.getFLAmt()));
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8124"), ByteUtils.hexString2ByteArray(jcbAid.getTxnAmt()));
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8126"), ByteUtils.hexString2ByteArray(jcbAid.getCVMLAmt()));
                                        ...
                                        //CUP
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8123"), ByteUtils.hexString2ByteArray(cupAid.getFLAmt()));
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8124"), ByteUtils.hexString2ByteArray(cupAid.getTxnAmt()));
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8126"), ByteUtils.hexString2ByteArray(cupAid.getCVMLAmt()));
                                    ...
                                    //   emvHandler2.setTlv(ByteUtils.hexString2ByteArray("9F66"), ByteUtils.hexString2ByteArray(visaAid.getTTQValue()));                                        log("Contact - Visa contact terminal capabilities are updated.");
                                        log("CTLS - Visa terminal capabilities are updated.");

//
                                        byte[] TTQR = emvHandler2.getTlv(ByteUtils.hexString2ByteArray("9F66"), EmvDataSourceEnum.FROM_KERNEL);
                                        Log.d("nexgo",  "configPaywaveParameters, TTQ" + ByteUtils.byteArray2HexString(TTQR));

                                        byte[] t9f33 = emvHandler2.getTlv(ByteUtils.hexString2ByteArray("9F33"), EmvDataSourceEnum.FROM_KERNEL);
                                        Log.d("nexgo",  "configPaywaveParameters, 9F33" + ByteUtils.byteArray2HexString(t9f33));
                                        ...
                                        //TacDefault
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8120"), ByteUtils.hexString2ByteArray("fc50bca000"));
                                        //TacDecline
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8121"), ByteUtils.hexString2ByteArray("0000000000"));
                                        //TacOnline
                                        emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8122"), ByteUtils.hexString2ByteArray("fc50bcf800"));
...
//                                    emvHandler2.setTlv(ByteUtils.hexString2ByteArray("DF8122"), ByteUtils.hexString2ByteArray("fc50808800"));
                            ...
                            public void onConfirmCardNo(CardInfoEntity info) {
                                ...
                                emvHandler2.getTlv(ByteUtils.hexString2ByteArray("9F33"),EmvDataSourceEnum.FROM_KERNEL);
                                log(ByteUtils.byteArray2HexString((emvHandler2.getTlv(ByteUtils.hexString2ByteArray("9F33"), EmvDataSourceEnum.FROM_KERNEL))));
...
//                                        Log.d("PINPAD","onInputResult : "+retCode);
//                                        pinAlertDialog.dismiss();
//                                        if (retCode == SdkResult.Success ) {
//                                            if (data != null) {
//                                                Log.d("PINPAD","data : "+data);
//                                                byte[] temp = new byte[8];
//                                                System.arraycopy(data, 0, temp, 0, 8);
//                                            }
//                                            byte[] t95 = emvHandler2.getTlv(ByteUtils.hexString2ByteArray("95"), EmvDataSourceEnum.FROM_KERNEL);
//                                            Log.d("nexgo",  "RESULT TAG, 95" + ByteUtils.byteArray2HexString(t95));
//                                         //   listener.onConfirm(data, isOnlinePin);
//                                            emvHandler2.onSetPinInputResponse(true, false);
//                                        }
...
//                                         //   listener.onpinbypass();
//                                            emvHandler2.onSetPinInputResponse(true, true);
//                                        }
//
//                                        else {
//                                            log("PIN enter failed. retCode: " + retCode);
...
//
                            ...
                            public void onOnlineProc() {
                                log("onOnlineProc()");
                                setIsamexmsd(false);
                                if(emvHandler2.getEmvContactlessMode() == MSD){
                                    if(isAmexAid()){
                                        setIsamexmsd(true);
                                        amextrack2 =ByteUtils.byteArray2HexString(emvHandler2.getTlv(ByteUtils.hexString2ByteArray("DF812B"),EmvDataSourceEnum.FROM_CARD));
                                        //  track2 = emvHandler2.getTlvByTags(new String[]{"DF812B"});
                                        amextrack2= Utility.asciiToString(amextrack2).replace("?","").replace(";","").trim();

                                        log("track2 : Amex : "+amextrack2 );
                                        //  read track 2 from DF812B

                                        if (!TextUtils.isEmpty(amextrack2)) {
                                            if (amextrack2.contains("F")) {
                                                amextrack2 = amextrack2.substring(0, amextrack2.length() - 1);
                                            }

                                            if (amextrack2.length() > 37) {
                                                amextrack2 = amextrack2.substring(0, 37);
                                            }
                                            amextrack2 = amextrack2.replace("D", "=");
                                        }
                                        setAmextrack2(amextrack2);

                                        log("track2 : "+ amextrack2);
...
//                                if(PromptEnum.OFFLINE_PIN_INCORRECT_TRY_AGAIN==promptEnum){
//                                    handler.post(() -> listener.onPinRequested(false, 1));
//                                }else {
//                                   emvHandler2.onSetPromptResponse(true);
//                                }
                            }
                            ...
                            public void onFinish(int retCode, EmvProcessResultEntity entity) {
                                log("onFinish()");
                                byte[] t95 = emvHandler2.getTlv(ByteUtils.hexString2ByteArray("95"), EmvDataSourceEnum.FROM_KERNEL);
                                Log.d("TAG95 : ",ByteUtils.byteArray2HexString(t95));
                                byte[] t9b = emvHandler2.getTlv(ByteUtils.hexString2ByteArray("9B"), EmvDataSourceEnum.FROM_KERNEL);
                                Log.d("TAG9B : ",ByteUtils.byteArray2HexString(t9b));
//                                if(emvHandler2.getEmvContactlessMode() == MSD){
//                                    if(isAmexAid()) {
//                                        setIsamexmsd(true);
//                                        if (SdkResult.Emv_Plz_See_Phone == retCode) {
//                                            handler.post(() -> {
//                                                CardData data = new CardData();
//                                                data.setPan("374245001761005");
//                                                data.setExpiryDate("0325");
//                                                data.setTrack2(ByteUtils.byteArray2HexString(emvHandler2.getTlv(ByteUtils.hexString2ByteArray("57"),EmvDataSourceEnum.FROM_CARD)));
//                                                log(data.toString());
//                                                listener.onCardData(finalCardAction, data);
//                                            });
//                                        }
...
//                                }
    ...
    private void setPaywaveDrl() {
        ...
        entity.setReaderContactlessTransLimitCheck(true);
        entity.setReaderCVMReqLimit(new byte[]{0x00, 0x00, 0x00, 0x75, 0x00, 0x00});
        entity.setReaderContactlessFloorLimit(new byte[]{0x00, 0x00, 0x00, 0x00, 0x00, 0x00});
        entity.setReaderContactlessTransLimit(new byte[]{0x00, 0x00, 0x20, 0x00, 0x00, 0x00});
...
//        dynamicReaderLimitEntity.add(entity3);
    ...
    private boolean isVisaAid() {
        return transactionAid.toUpperCase().contains("A000000003")
    ...
    private boolean isMasterAid() {
        return transactionAid.toUpperCase().contains("A0000000041010")
                || transactionAid.toUpperCase().contains("A0000000043060")
    ...
    private boolean isCUPAid() {
        return transactionAid.toUpperCase().contains("A000000333010101")
                ...
                || transactionAid.toUpperCase().contains("A000000333010108")
    ...
    private void onEmvProcessFinished(int retCode, EmvProcessResultEntity entity, PosCheckCardListener listener) {
        ...
        log("onEmvProcessFinished -retCode()" +retCode);
...
//        }
        ...
        switch (retCode) {
            ...
            case SdkResult.Emv_Arpc_Fail:
                msg = "Unable to Go Online-\"Offline decline";
                break;
...
//                }
            ...
            case SdkResult.Emv_Terminate:
                ...
                break;
            case SdkResult.Emv_CTLS_EndApplication:
                //transaction terminate
...
//                else if (retCode == SdkResult.Emv_Qpboc_Offline) {   //remove from live
//                    log("success.");
//                    setTransResult(TransResult.TRADE_SUCCESS);
//                    writeEmvTagsOnFile();
//                    listener.onOfflineapprove();
//                }
//                else if (retCode == SdkResult.Emv_Plz_See_Phone) {
//                    log("successSEEPHONE.");
//                    isExpressPaySeePhoneTapCardAgain=false;
//                    setTransResult(TransResult.TRADE_SUCCESS);
//                  //  writeEmvTagsOnFile();
...
//                }
    ...
    public void launchPinPad(int workKeyId, boolean isOnlinePin, boolean isPinBypass, String pan, String promptString, PosPinListener listener) {
        ...
        pinAlertDialog.show();
        tvPin.setText(pwdText);
        Log.d("PINPAD","isOnlinePin : "+isOnlinePin);
        Log.d("PINPAD","isPinBypass : "+isPinBypass);
        Log.d("PINPAD","workKeyId : "+workKeyId);
        Log.d("PINPAD","pan : "+pan);
        ...
        try {
            ...
            if (isOnlinePin) {
                Log.d("PINPAD","online  : "+isOnlinePin);
    ...
    public void getTLVFromTags(CardType cardType, GetTLVDataListener listener) {
        ...
        if (cardType == CardType.MASTER) {
            ...
            tagList = EmvData.JCB_TAG_LIST_STRING;
        }
        ...
        String finalTlv2 =finalTlv +"9F410400000022";
        log("TLV: " + finalTlv);
        log("9f41: " + emvHandler2.getTlvByTags(new String[]{"9f41"}));
...
//        if(emvHandler2.getEmvContactlessMode() == MSD){
//            if(isAmexAid()){
//                track2 =ByteUtils.byteArray2HexString(emvHandler2.getTlv(ByteUtils.hexString2ByteArray("DF812B"),EmvDataSourceEnum.FROM_CARD));
//                log("track2 : Amex : "+ track2);
//               // track2 = emvHandler2.getTlvByTags(new String[]{"DF812B"});
//              //  read track 2 from DF812B
//            }
//        }
...
//        -------------------------
        ...
        try {
            if (isEmv) {
                ...
                String nine = getTagData("9F6E");
                String add = getTagData("9F40");
                log("9F40 : " + add);
                log("9F6E : " + nine);
    ...
    public String getAmextrack2() {
        return amextrack2;
    }

    public void setAmextrack2(String amextrack2) {
        this.amextrack2 = amextrack2;
    }

    public  String amextrack2 ="";

    public boolean isIsamexmsd() {
        return isamexmsd;
    }

    public void setIsamexmsd(boolean isamexmsd) {
        this.isamexmsd = isamexmsd;
    }
    public void initECR() {

        int estatus =  PosDevice.getInstance().platform.enableUsbCdc();
        log("ECR Enable CDC status " +estatus);
...
//            log("WriteWKey MACKEY result:" + result);
          ...
          int  result = pinPad.writeWKey(workKeyId, WorkKeyTypeEnum.PINKEY, work_key_data, work_key_data.length);
    ...
    public int  installapplication(String apkPath){
        Log.d("posDevice-apkPath: ", apkPath);
        platform.installApp(apkPath, new OnAppOperatListener() {
            @Override
            public void onOperatResult(int i) {
                Log.d("APPLICATIONINSTALL : ", String.valueOf(i));
                installResult = i;
...
//                            });
    ...
    // </editor-fold>
        ...
        public int uninstallApp(String appPackageName , MainSDK mainSDK , String appVersion) {


        platform.uninstallApp( appPackageName, new OnAppOperatListener() {

            @Override
            public void onOperatResult(int i) {
                Log.d("APPLICATION-UNINSTALL : ", String.valueOf(i));
                uninstallResult = i;
                log("UnInstallResult: "+i);
            }
        });
